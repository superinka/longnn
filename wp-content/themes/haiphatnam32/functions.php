...
function theme_styles() {
    ...
    //    <!-- Flat icon css -->
    wp_enqueue_style( 'flaticon', get_template_directory_uri() . '/assets/vendor/flat-icon/flaticon.css');

    //    <!-- Font awesome -->
    wp_enqueue_style( 'fontawesome', get_template_directory_uri() . '/assets/vendor/font-awesome/css/font-awesome.min.css');
    
    //    <!-- Owl Carosel css -->
    wp_enqueue_style( 'owl-carousel', get_template_directory_uri() . '/assets/vendor/owl/css/owl.carousel.css');
    wp_enqueue_style( 'owl-theme-default', get_template_directory_uri() . '/assets/vendor/owl/css/owl.theme.default.css');
    wp_enqueue_style( 'owl-theme', get_template_directory_uri() . '/assets/vendor/owl/css/owl.theme.css');

    //    <!-- mmenu -->
    wp_enqueue_style( 'menu', get_template_directory_uri() . '/assets/vendor/mmenu/css/jquery.mmenu.css');

    //  <!-- Bootstrap css -->
    wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/assets/vendor/bootstrap/css/bootstrap.css');
